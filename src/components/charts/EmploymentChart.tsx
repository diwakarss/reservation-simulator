...
/**
 * EmploymentChart - Multi-line chart showing employment rates over time
 *
 * Tracks formal employment percentage for each class tier over the simulation timeline.
 */
